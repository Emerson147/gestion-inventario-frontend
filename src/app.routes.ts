...
export const routes: Routes = [
  ...
  // Rutas protegidas con layout de Sakai NG
  {
    ...
    children: [
      ...
      {
        path: 'admin',
        loadChildren: () => import('./app/features/admin/admin-routing.module').then(m => m.AdminRoutingModule),
      ...
      {
        path: 'ventas',
        loadChildren: () => import('./app/features/ventas/ventas-routing.module').then(m => m.VentasRoutingModule),
